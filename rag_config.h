...
#define CHUNKS_PER_PAGE  4
    ...
    #define TOTAL_PAGES_TO_SCAN     (2680000 / CHUNKS_PER_PAGE) // 670,000 Pages
...
// 定義 RAG 觸發的起始 LBA (假設從 10GB 之後開始)
// 10GB / 512B (LBA size) = 20971520
#define RAG_LBA_THRESHOLD   20971520  
